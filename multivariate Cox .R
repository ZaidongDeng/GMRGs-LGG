...
setwd("D:\\生信分析课题\\泛癌数据\\谷胱甘肽途径\\14单因素分析\\CCGA")     #设置工作目录
...
indep=function(riskFile=null,cliFile=null,uniOutFile=null,multiOutFile=null,uniForest=null,multiForest=null){
  ...
  bioForest(coxFile=uniOutFile, forestFile=uniForest, forestCol="mediumvioletred")
...
#调用函数，进行独立预后分析
indep(riskFile="risk_CCGA693.txt",
      cliFile="CCGA_clinical1.txt",
